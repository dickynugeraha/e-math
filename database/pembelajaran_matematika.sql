...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2023 at 08:18 AM
...
(1, 1, '90 cm', '100 cm', '80 cm', '625 cm', 'b', 'Rumus keliling persegi adalah 4 * Sisi/nSehingga, 4 * 25cm = 100 cm/nDan jawaban yang benar adalah B'),
...
INSERT INTO `forum` (`id`, `title`, `created_at`) VALUES
(2, 'Kelas 4B', '2023-07-18 09:14:46'),
(3, 'Kelas 4C', '2023-07-18 09:19:53');
...
INSERT INTO `forum_item` (`id`, `name`, `description`, `forumId`, `user_status`, `created_at`) VALUES
(4, 'Kale', 'Jelaskan apa manfaat mengetahui konsep bangun ruang', 2, 'Guru', '2023-07-18 19:42:56'),
(5, 'Rafif Harmanto', 'Bangun ruang adalah bangun ruang', 2, 'Siswa', '2023-07-19 04:31:37'),
(6, 'Kale', 'Yang lain mana jawabannya?', 2, 'Guru', '2023-07-19 04:32:47');
...
(1, 'pilihan_ganda', 'Berapakah luas keliling dari persegi ABCD, jika diketahui panjang sisinya adalah 25 cm', 'https://www.advernesia.com/wp-content/uploads/2018/10/Sudut-persegi.png'),
(2, 'pilihan_ganda', 'Diketahui ada sebuah kubus dengan Panjang rusuk sepanjang 11 cm . berapakah  volume kubus tersebut ?', 'https://cdn0-production-images-kly.akamaized.net/PjlWbK0Q83FDiUQtaoqXq058964=/640x640/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/3518168/original/026826900_1626957470-KUBUSSS.jpg'),
(3, 'pilihan_ganda', 'Sebuah tabung memiliki jari-jari 21 cm dan tinggi 5 cm, berapakah volume tabung tersebut?', 'https://asset-a.grid.id//crop/0x0:0x0/700x0/photo/2022/03/29/tabungjpeg-20220329043914.jpeg'),
(4, 'pilihan_ganda', 'Diketahui sebuah balok berukuran Panjang 6 cm , lebar 7 cm , dan tinggi 8 cm. berapakah luas permukaan balok tersebut?', 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Cuboid_simple.svg/1200px-Cuboid_simple.svg.png'),
(5, 'pilihan_ganda', 'Diketahui sebuah limas setinggi 3 cm memiliki alas berbentuk persegi yang Panjang rusuk alasnya adalah 8cm . jika sisi tegak limas adalah 5 cm , hitung lah volume limas?', 'https://core-ruangguru.s3.amazonaws.com/assets/ruang_belajar/questions/q_h79scl5077.PNG'),
(6, 'pilihan_ganda', 'Diketahui sebuah kerucut memiliki jari – jari alas 21 cm dan Panjang  garis pelukis 29 cm. hitung lah luas permukaan!', 'https://upload.wikimedia.org/wikipedia/id/thumb/5/5c/Kerucut.JPG/220px-Kerucut.JPG'),
(7, 'pilihan_ganda', 'Sebuah persegi Panjang memiliki ukuran Panjang 10 cm dan lebar 5 cm . berapa luas persegi Panjang tersebut ?', 'https://pict.sindonews.net/dyn/620/pena/news/2022/09/21/212/891055/rumus-luas-persegi-panjang-beserta-cara-menghitung-dan-contoh-soalnya-fds.jpg'),
(8, 'pilihan_ganda', 'Sebuah segitiga memiliki sisi alas 10 cm,  dan tinggi 7 cm. ukuran sisi miring nya 8cm dan 9cm . berapa luas segitiga tersebut ? ', 'https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1616065047/seaqcrd8h0wlfbc0gkyx.jpg'),
(9, 'pilihan_ganda', 'Sebuah belah ketupat memiliki diagonal 10 cm dan 14 cm . Panjang sisi nya 8 cm. berapa keliling belah ketupat tersebut ?', 'https://rumuspintar.com/wp-content/uploads/2019/07/Belah-Ketupat.jpg'),
(10, 'pilihan_ganda', 'Sebuah lingkaran memiliki jari -jari 7 cm . berapa luas lingkaran tersebut ?', 'https://blue.kumparan.com/image/upload/v1642575394/jsb1x9fwcjndcjv3bbej.png'),
(11, 'pilihan_ganda', 'Sebuah jajar genjang memiliki alas yang Panjang 12 cm dan tinggi 5 cm . berapa luas jajargenjang tersebut ? ', 'https://asset.kompas.com/data/photo/2021/03/01/603d0e8e21660.png'),
...
INSERT INTO `reports` (`id`, `userId`, `nilai`, `type`) VALUES
(1, 3, 50, 'pilihan_ganda'),
(2, 3, 80, 'tebak_gambar'),
(3, 3, 50, 'pilihan_ganda'),
(4, 3, 100, 'tebak_gambar');
...
ALTER TABLE `forum_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `forum_item_ibfk_1` (`forumId`);
...
--
ALTER TABLE `answers`
  ADD CONSTRAINT `answers_ibfk_1` FOREIGN KEY (`quizId`) REFERENCES `quiz` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `forum_item`
--
ALTER TABLE `forum_item`
  ADD CONSTRAINT `forum_item_ibfk_1` FOREIGN KEY (`forumId`) REFERENCES `forum` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
